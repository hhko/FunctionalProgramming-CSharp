...
public static class FourFunctionTypes
{
    ...
    {
        Console.WriteLine("== §1.7 두 세계 사이를 오가는 4 가지 함수 ==");
        ...
        Console.WriteLine();
        Console.WriteLine("  [② a → E<b> — 월드 교차 함수 (6장 Monad / bind 의 자리)]");
        ...
        Console.WriteLine("    → 직접 합성 불가능. 8장의 `bind` 가 ② 를 ④ 로 끌어올려 합성을 회복.");

        // ③ E<a> → b — 끌어내림.
        Console.WriteLine();
        Console.WriteLine("  [③ E<a> → b — 끌어내림 (5장 Foldable / fold 의 자리)]");
        ...
        Console.WriteLine();
        Console.WriteLine("  [④ E<a> → E<b> — 완전히 끌어올린 함수 (3장 Functor / map 의 자리)]");
        ...
        Console.WriteLine("    → 컨테이너 모양은 보존, 안의 값만 변환. 두 ④ 는 평범한 합성으로 이어 붙는다.");
    }
