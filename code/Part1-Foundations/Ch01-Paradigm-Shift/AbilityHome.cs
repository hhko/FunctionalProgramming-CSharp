...
// 본문 §1.5 — 능력은 어디 사는가 (한 차원 비교).
//
// 명령형: 능력 = 함수의 본문 / 객체 지향: 능력 = 객체에 묶인 메서드 / 함수형:
// 능력 = trait (책장) 의 정적 자리. 2-3장의 *trait + static abstract* 가 이를 코드로 한다.
public static class AbilityHome
{
    public static void Run()
    {
        Console.WriteLine("== §1.5 능력은 어디 사는가 — 한 차원 비교 ==");
        ...
        // 본격 trait + static abstract 는 2-3장 (Higher Kinds + Functor) 에서 본다.
