...
// 함수형 (함수의 합성).
//
// *불변* + *합성* + *추상* 의 세 결합. *같은 문제, 세 패러다임의 풀이* 가
// 세 풀이의 *모양 차이* 를 직접 비교하는 자리.
public static class FunctionalStyle
{
    public static void Run()
    {
        Console.WriteLine("== 함수형 — 함수의 합성 ==");

        // Aggregate (fold) 한 줄. 상태 변수 없음.
        ...
        // 같은 문제 (짝수의 제곱합) 를 세 패러다임으로.
        Console.WriteLine();
        Console.WriteLine("  [같은 문제, 세 패러다임의 풀이 — 짝수의 제곱합]");
