...
2장은 1장과 마찬가지로 도구를 나열하는 장이 아닙니다. 먼저 **`F` 자리가 없으면 어떤 고통이 생기는지** 를 직접 체험하고, 그 고통을 C# 으로 풀려다 **벽에 부딪힌 뒤**, 그 벽이 정확히 무엇인지 어휘로 정착시키고, 벽을 우회하는 세 도구를 차례로 놓습니다. 고통 → 벽 → 우회의 순서입니다.
